...
// 1. Usamos for...of para recorrer los usuarios
for (const user of users) {
  // 2. Usamos for...in para recorrer las propiedades (sonidos) del objeto favoritesSounds
...
const media = totalVolume / totalSounds;

console.log(`La media de volumen es: ${media}`);